...
#define APPLY_FOR_PARSER_KEYWORDS(MR_MACROS) \
    ...
    MR_MACROS(ALTER_MASKING_POLICY, "ALTER MASKING POLICY") \
    ...
    MR_MACROS(AT, "AT") \
    MR_MACROS(AT_TIME_ZONE, "AT TIME ZONE") \
    ...
    MR_MACROS(ATTACH_MASKING_POLICY, "ATTACH MASKING POLICY") \
    ...
    MR_MACROS(BOTH, "BOTH") \
    MR_MACROS(BOUNDED, "BOUNDED") \
    MR_MACROS(BY, "BY") \
    MR_MACROS(CASCADE, "CASCADE") \
    MR_MACROS(CASE, "CASE") \
    MR_MACROS(CAST, "CAST") \
    MR_MACROS(CENTURY, "CENTURY") \
    ...
    MR_MACROS(CHECK_DATABASE, "CHECK DATABASE") \
    ...
    MR_MACROS(COPY, "COPY") \
    MR_MACROS(CREATE_MASKING_POLICY, "CREATE MASKING POLICY") \
    ...
    MR_MACROS(CREATE_TOKEN, "CREATE TOKEN") \
    ...
    MR_MACROS(DAYS, "DAYS") \
    MR_MACROS(DD, "DD") \
    MR_MACROS(DECADE, "DECADE") \
    MR_MACROS(DEALLOCATE, "DEALLOCATE") \
    ...
    MR_MACROS(DETERMINISTIC, "DETERMINISTIC") \
    ...
    MR_MACROS(UNLOCK_SNAPSHOT, "UNLOCK SNAPSHOT") \
    MR_MACROS(FROM_INFILE, "FROM INFILE") \
    MR_MACROS(FROM_SHARD, "FROM SHARD") \
    MR_MACROS(FROM_SNAPSHOT, "FROM SNAPSHOT") \
    MR_MACROS(FROM, "FROM") \
    MR_MACROS(FULL, "FULL") \
    ...
    MR_MACROS(HTTP, "HTTP") \
    MR_MACROS(HYPOTHETICAL, "HYPOTHETICAL") \
    MR_MACROS(ID, "ID") \
    ...
    MR_MACROS(IDLE_TIMEOUT, "IDLE TIMEOUT") \
    ...
    MR_MACROS(IP, "IP") \
    MR_MACROS(ISODOW, "ISODOW") \
    MR_MACROS(ISOYEAR, "ISOYEAR") \
    MR_MACROS(IS_NOT_DISTINCT_FROM, "IS NOT DISTINCT FROM") \
    MR_MACROS(IS_DISTINCT_FROM, "IS DISTINCT FROM") \
    MR_MACROS(IS_NOT_NULL, "IS NOT NULL") \
    MR_MACROS(IS_NULL, "IS NULL") \
    MR_MACROS(IS_NOT_UNKNOWN, "IS NOT UNKNOWN") \
    MR_MACROS(IS_UNKNOWN, "IS UNKNOWN") \
    MR_MACROS(IS_NOT_FALSE, "IS NOT FALSE") \
    MR_MACROS(IS_FALSE, "IS FALSE") \
    MR_MACROS(IS_NOT_TRUE, "IS NOT TRUE") \
    MR_MACROS(IS_TRUE, "IS TRUE") \
    MR_MACROS(JOIN, "JOIN") \
    MR_MACROS(JWT, "JWT") \
    ...
    MR_MACROS(MEMORY_RESERVATION, "MEMORY RESERVATION") \
    MR_MACROS(MERGES, "MERGES") \
    MR_MACROS(METHODS, "METHODS") \
    ...
    MR_MACROS(MILLENNIUM, "MILLENNIUM") \
    MR_MACROS(MIN, "MIN") \
    ...
    MR_MACROS(MODIFY_CONSTRAINT, "MODIFY CONSTRAINT") \
    MR_MACROS(MODIFY_DATABASE_COMMENT, "MODIFY DATABASE COMMENT") \
    MR_MACROS(MODIFY_DEFINER, "MODIFY DEFINER") \
    MR_MACROS(MODIFY_ORDER_BY, "MODIFY ORDER BY") \
    MR_MACROS(MODIFY_PROJECTION, "MODIFY PROJECTION") \
    ...
    MR_MACROS(RECENT_SAMPLES, "RECENT SAMPLES") \
    ...
    MR_MACROS(RETURNS, "RETURNS") \
    MR_MACROS(REVOKE, "REVOKE") \
    MR_MACROS(REWRITE_PARTS, "REWRITE PARTS") \
    ...
    MR_MACROS(SEMI, "SEMI") \
    MR_MACROS(SEQUENTIAL, "SEQUENTIAL") \
    ...
    MR_MACROS(UNIQUE_KEY, "UNIQUE KEY") \
    MR_MACROS(UNORDERED, "UNORDERED") \
    ...
    MR_MACROS(WITH_SETTINGS, "WITH SETTINGS") \
    MR_MACROS(WITH, "WITH") \
    MR_MACROS(WORKER_THREAD, "WORKER THREAD") \
...
#define APPLY_FOR_PARSER_KEYWORDS_WITH_UNDERSCORES(MR_MACROS) \
    ...
    MR_MACROS(SCRAM_SHA256_HASH, "SCRAM_SHA256_HASH") \
    MR_MACROS(SCRAM_SHA256_PASSWORD, "SCRAM_SHA256_PASSWORD") \
...
#define DECLARE_PARSER_KEYWORD_ENUM(identifier, name) identifier,
    ...
    APPLY_FOR_PARSER_KEYWORDS(DECLARE_PARSER_KEYWORD_ENUM) APPLY_FOR_PARSER_KEYWORDS_WITH_UNDERSCORES(DECLARE_PARSER_KEYWORD_ENUM)
