...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"input_format_arrow_enable_json_parsing", false, true, "When reading Arrow/ArrowStream, parse `arrow.json` (and unshredded `arrow.parquet.variant`) columns as ClickHouse JSON."},
